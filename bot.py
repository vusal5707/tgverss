...
@dp.callback_query_handler(Text("change_priority"))
...
@dp.callback_query_handler(Text(lambda c: c.data.startswith("priority_")))
...
@dp.callback_query_handler(Text("settings_menu"))
...
@dp.callback_query_handler(Text("change_menu_name"))
